...
class Portfolio(object):
    ...
    """
    Core portfolio object - Base class
    ...
    def __repr__(self):
        return "Portfoio object with %d equity curves" % len(
            self.get_equity_curve_list()) #TODO: change
    ...
    def get_raw_equity_curve(self, system_code):
        """
        Default method to get equity curve
        Will usually be overriden when inherited with specific portfolio source

        :param system_code: system to get equity curve for
        :type system_code: str

        :returns: pd.Series

        """
        error_msg="You have created a Portfolio() object; you might need to use a more specific portfolio object" % system_code
    ...
    def keys(self):
        """
        list of equity curves in this portfolio set
    ...
    def _get_fx_cross(self, currency1, currency2):
        ...
        if fx_rate_series is None:
            ...
            (aligned_c1, aligned_c2)=currency1_vs_default.align(currency2_vs_default, join="outer") 
