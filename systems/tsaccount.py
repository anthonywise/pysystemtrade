...
class TSAccount(SystemStage):
    """
    SystemStage for ts portfolio accounting
    ...
    def __init__(self):
        """
        Create a SystemStage for ts portfolio accounting



        """
        setattr(self, "name", "tsaccounts")
        setattr(self, "description", "TSAccount()")
    ...
    def get_value_of_price_move(self, instrument_code):
        ...
        def _get_value_of_price_move(system, instrument_code, this_stage):
            return  system.tsportfolio.get_value_of_block_price_move(
                                                        instrument_code)
    ...
    def get_raw_cost_data(self, instrument_code):
        ...
        def _get_raw_cost_data(system, instrument_code, this_stage):
            return system.tsportfolio.get_raw_cost_data(instrument_code)
